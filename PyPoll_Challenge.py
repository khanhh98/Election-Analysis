...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes_county > winning_county_votes) and (votes_county_percentage > winning_county_percentage):
    ...
    print(winning_county_candidate)
    # 8: Save the county with the largest turnout to a text file.
    txt_file.write(winning_county_candidate)
